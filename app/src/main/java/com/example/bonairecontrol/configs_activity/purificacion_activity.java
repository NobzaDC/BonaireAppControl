...
public class purificacion_activity extends AppCompatActivity {

    TextView txt_nombre_disposistivo_purificacion, txt_info_data_pwm_purificacion, txt_info_data_servo_purificacion;

    SeekBar seek_bar_servo_purificacion, seek_bar_pwm_purificacion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_purificacion_activity);
        ...
        txt_nombre_disposistivo_purificacion = findViewById(R.id.txt_nombre_disposistivo_purificacion);
        txt_info_data_pwm_purificacion = findViewById(R.id.txt_info_data_pwm_purificacion);
        txt_info_data_servo_purificacion = findViewById(R.id.txt_info_data_servo_purificacion);
        seek_bar_servo_purificacion = findViewById(R.id.seek_bar_servo_purificacion);
        seek_bar_pwm_purificacion = findViewById(R.id.seek_bar_pwm_purificacion);
        ...
        txt_nombre_disposistivo_purificacion.setText(nombreEquipo);

        seek_bar_pwm_purificacion.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                txt_info_data_pwm_purificacion.setText("" + progress);
            }
        ...
        seek_bar_servo_purificacion.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                txt_info_data_servo_purificacion.setText("" + progress);
            }
    ...
    public void fncBtnSave(View view) {
        ...
        dato_pwm = (seek_bar_pwm_purificacion.getProgress()*220)/100;
        dato_servo = (seek_bar_servo_purificacion.getProgress()*180)/100;

        if (dato_pwm != 0 && dato_servo != 0){

            if (dato_pwm != 0){
                fncEnviarDatos("PURIFICACION_SET_PWM:" + dato_pwm);
            }

            if (dato_servo != 0){
                fncEnviarDatos("PURIFICACION_SET_PWM:" + dato_servo);
            }
